      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between border-t pt-2 font-semibold"><span className="text-foreground">Gross</span><span className="text-foreground">${payslip.grossEarnings}</span></div>
          </div>
        </div>
        <div>
          <h4 className="mb-3 font-semibold text-foreground">Deductions</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between"><span className="text-muted-foreground">PF</span><span className="text-foreground">${payslip.providentFund}</span></div>
            <div className="flex justify-between"><span className="text-muted-foreground">Prof. Tax</span><span className="text-foreground">${payslip.professionalTax}</span></div>
            ...
            <div className="flex justify-between border-t pt-2 font-semibold"><span className="text-foreground">Total</span><span className="text-destructive">${payslip.totalDeductions}</span></div>
          </div>
        </div>
      </div>
